...
<div class="max-w-2xl mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Cadastrar Clínica</h1>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" action="{{ route('clinics.store') }}">
            ...
            <div class="mt-6 flex justify-end">
                <a href="{{ route('dashboard') }}" class="text-gray-600 hover:text-gray-800 mr-4 text-sm self-center">Cancelar</a>
