        ...
        <div class="bg-white shadow-lg rounded-lg p-8 max-w-xl mx-auto">
            ...
            <form action="{{ route('pacientes.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="datetime-local" id="birth_date" name="birth_date" value="{{ old('birth_date') }}"
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
                    @error('birth_date')
                        <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-6">
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="smoker" value="1" {{ old('smoker') == '1' ? 'checked' : '' }}
                                   class="mr-2 text-blue-600">
                            <span class="text-gray-700">Sim</span>
                        </label>
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="smoker" value="0" {{ old('smoker', '0') == '0' ? 'checked' : '' }}
                                   class="mr-2 text-blue-600">
